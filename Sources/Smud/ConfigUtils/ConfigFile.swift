...
public class ConfigFile {
    ...
    public func get<T: OptionSet>(_ name: String) -> T? where T.RawValue == Int {
        //UnsignedInteger {
    ...
    public func set<T>(_ name: String, _ value: T?) where T: UnsignedInteger{
        if let value = value {
    ...
    public func set<T: OptionSet>(_ name: String, _ value: T?) where T.RawValue == Int, T.Element == T {
        if let value = value {
            var out = "("
            var first = true
    ...
    func scanNextSection() throws {
        ...
        while true {
            ...
            if field.last != ":" {
                ...
                field = String(field.prefix(upTo: field.endIndex))
    ...
    func scanMultilineField() throws -> String {
        ...
        if value.hasSuffix("\n") {
            value = String(value.prefix(upTo: value.endIndex))
        }
        return value
    }
